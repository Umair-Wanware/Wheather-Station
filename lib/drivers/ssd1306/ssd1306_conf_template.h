...
// Choose a microcontroller family (STM32F103/STM32F1 only)
// STM32F1 should be defined by the build system (e.g., -DSTM32F1 in platformio.ini)
// All other MCU families are not supported in this configuration


// Choose a bus (I2C only for STM32F103)
#define SSD1306_USE_I2C
// #define SSD1306_USE_SPI


// I2C Configuration (default for STM32F103)
#define SSD1306_I2C_PORT        hi2c
#define SSD1306_I2C_ADDR        (0x3C << 1)


// SPI Configuration (not used for STM32F103 in this setup)
